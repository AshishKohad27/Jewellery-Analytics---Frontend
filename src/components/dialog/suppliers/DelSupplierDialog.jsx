...
export default function DelSupplierDialog() {
  return (
    <Dialog >
      <DialogTrigger asChild >
        <button class="p-1.5 text-slate-400 hover:text-red-600 hover:bg-red-50 rounded">
          <svg
            class="w-4 h-4"
            fill="none"
            stroke="currentColor"
        ...
        >
          <div class="p-6">
            ...
            <p class="text-sm text-slate-500 text-center mt-2">
              ...
              <span id="deleteSupplierName" class="font-medium text-slate-700">
                Rajesh Gold Traders
              </span>
              ? This action can be reversed later.
            </p>
            <input type="hidden" id="deleteSupplierId" value="1" />
          </div>
          {/* Footer */}
          <div className="flex items-center justify-end gap-3 p-6 border-t border-slate-200">
            ...
            <button
              ...
              class="px-4 py-2.5 bg-red-600 text-white hover:bg-red-700 rounded-lg text-sm font-medium transition-colors"
            >
              Confirm Deactivate
            </button>
          </div>
